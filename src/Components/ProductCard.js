function ProductCard(props) { 
  ...
  return (
    <div className='rounded-2xl border-2 border-[#56efd3] bg-[#56efd3] w-10/12 xl:w-9/12 mx-auto transition-all hover:border-[#ff7795] hover:bg-[#ff7795] hover:-translate-y-2'>
      <button className='h-full flex flex-col justify-between' onClick={() => props.handleClick(props.img, props.name, props.price, props.stock, props.description)}>
        <img
          ...
          alt='product'
          src={require(`../productsImages/${props.img}.jpg`)}          
        />
