            ...
            <div className='flex flex-col bg-[#f8efe6] p-2 border-2 border-black text-[1.5rem] rounded-lg'>
                ...
                <div className='p-8'>
                    ...
                    <div className='flex justify-around pt-8'>
                        <button className='text-sm text-white transition duration-150 hover:bg-[#b6efb0] bg-[#93c47d]  font-bold py-2 px-6 rounded' onClick={() => { props.deleteProveedor() }}>Sí</button>
